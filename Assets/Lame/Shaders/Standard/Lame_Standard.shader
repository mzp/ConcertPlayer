...
Shader "Lame/Standard"
{
    Properties
    {
        ...
        [Toggle]
        _IndependLameRGB ("Indipend Lame RGB From StandardRGB", int) = 0
        [Toggle]
        _IndependLameAlpha ("Indipend Lame Alpha From StandardAlpha", int) = 0
        [Toggle]
        ...
        [Header(VRC Options)]
        _MinimalBrightness ("Minimal Light", Range(0, 1)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #endif
            #include "Lame_UnityStandardCoreForward.cginc"
    ...
    FallBack "VertexLit"
    CustomEditor "LameStandardShaderGUI"
}
